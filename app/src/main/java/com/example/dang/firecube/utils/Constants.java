...
public class Constants {
    ...
    public static final String FIRECUBE1 = "firecube1";
    public static final String FIRECUBE2 = "firecube2";
    public static final String FIRECUBE3 = "firecube3";
    public static final String FIRECUBE4 = "firecube4";
    public static final String FIRECUBE5 = "firecube5";
    public static final String FIRECUBE6 = "firecube6";
