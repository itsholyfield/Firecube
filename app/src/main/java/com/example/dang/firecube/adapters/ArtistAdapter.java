...
public class ArtistAdapter extends RecyclerView.Adapter<ArtistAdapter.ItemHolder> implements BubbleTextGetter {
    ...
    public void onBindViewHolder(final ItemHolder itemHolder, int i) {
        ...
        String albumNmber = FirecubeUtils.makeLabel(mContext, R.plurals.Nalbums, localItem.albumCount);
        String songCount = FirecubeUtils.makeLabel(mContext, R.plurals.Nsongs, localItem.songCount);
        itemHolder.albums.setText(FirecubeUtils.makeCombinedString(mContext, albumNmber, songCount));
