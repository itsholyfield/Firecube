...
import com.example.dang.firecube.helpers.MediaButtonIntentReceiver;
import com.example.dang.firecube.helpers.MusicPlaybackTrack;
import com.example.dang.firecube.lastfmapi.LastFmClient;
import com.example.dang.firecube.lastfmapi.models.LastfmUserSession;
import com.example.dang.firecube.lastfmapi.models.ScrobbleQuery;
import com.example.dang.firecube.permissions.Nammu;
import com.example.dang.firecube.provider.MusicPlaybackState;
import com.example.dang.firecube.provider.RecentStore;
import com.example.dang.firecube.provider.SongPlayCount;
...
import com.example.dang.firecube.utils.FirecubeUtils.IdType;
...
public class MusicService extends Service {
    public static final String PLAYSTATE_CHANGED = "com.example.dang.firecube.playstatechanged";
    public static final String POSITION_CHANGED = "com.example.dang.firecube.positionchanged";
    public static final String META_CHANGED = "com.example.dang.firecube.metachanged";
    public static final String QUEUE_CHANGED = "com.example.dang.firecube.queuechanged";
    public static final String PLAYLIST_CHANGED = "com.example.dang.firecube.playlistchanged";
    public static final String REPEATMODE_CHANGED = "com.example.dang.firecube.repeatmodechanged";
    public static final String SHUFFLEMODE_CHANGED = "com.example.dang.firecube.shufflemodechanged";
    public static final String TRACK_ERROR = "com.example.dang.firecube.trackerror";
    public static final String Firecube_PACKAGE_NAME = "com.example.dang.firecube";
    public static final String MUSIC_PACKAGE_NAME = "com.android.music";
    public static final String SERVICECMD = "com.example.dang.firecube.musicservicecommand";
    public static final String TOGGLEPAUSE_ACTION = "com.example.dang.firecube.togglepause";
    public static final String PAUSE_ACTION = "com.example.dang.firecube.pause";
    public static final String STOP_ACTION = "com.example.dang.firecube.stop";
    public static final String PREVIOUS_ACTION = "com.example.dang.firecube.previous";
    public static final String PREVIOUS_FORCE_ACTION = "com.example.dang.firecube.previous.force";
    public static final String NEXT_ACTION = "fcom.example.dang.firecube.next";
    public static final String REPEAT_ACTION = "com.example.dang.firecube.repeat";
    public static final String SHUFFLE_ACTION = "com.example.dang.firecube.shuffle";
    public static final String FROM_MEDIA_BUTTON = "frommediabutton";
    public static final String REFRESH = "com.example.dang.firecube.refresh";
    public static final String UPDATE_LOCKSCREEN = "com.example.dang.firecube.updatelockscreen";
    ...
    private static final String SHUTDOWN = "com.example.dang.firecube.shutdown";
    ...
    private void setUpMediaSession() {
        mSession = new MediaSessionCompat(this, "Firecube");
    ...
    public void onDestroy() {
        ...
        if (FirecubeUtils.isJellyBeanMR2())
    ...
    private int getCardId() {
        if (FirecubeUtils.isMarshmallow()) {
    ...
    private void addToPlayList(final long[] list, int position, long sourceId, FirecubeUtils.IdType sourceType) {
    ...
    private void doAutoShuffleUpdate() {
        ...
        for (int i = 0; i < toAdd; i++) {
            ...
            mPlaylist.add(new MusicPlaybackTrack(mAutoShuffleList[idx], -1, FirecubeUtils.IdType.NA, -1));
            notify = true;
        }
        if (notify) {
            notifyChange(QUEUE_CHANGED);
    ...
    private void notifyChange(final String what) {
        ...
        musicIntent.setAction(what.replace(Firecube_PACKAGE_NAME, MUSIC_PACKAGE_NAME));
        ...
        if (mRemoteControlClient != null) {
            ...
            if (what.equals(META_CHANGED) || what.equals(QUEUE_CHANGED)) {
                ...
                if (mShowAlbumArtOnLockscreen) {
                    albumArt = ImageLoader.getInstance().loadImageSync(FirecubeUtils.getAlbumArtUri(getAlbumId()).toString());
                    if (albumArt != null) {
    ...
    private Notification buildNotification() {
        ...
        Bitmap artwork;
        artwork = ImageLoader.getInstance().loadImageSync(FirecubeUtils.getAlbumArtUri(getAlbumId()).toString());
        ...
        if (FirecubeUtils.isJellyBeanMR1()) {
        ...
        if (artwork != null && FirecubeUtils.isLollipop())
            ...
            if (c != null && c.getCount() != 0) {
                ...
                do {
                    TrackItem t = new TrackItem()
                            .setArt(FirecubeUtils.getAlbumArtUri(c.getLong(c.getColumnIndexOrThrow(AudioColumns.ALBUM_ID))))
                            ...
                            .setDuration(FirecubeUtils.makeShortTimeString(this, c.getInt(c.getColumnIndexOrThrow(AudioColumns.DURATION)) / 1000));
                    list.add(t.get());
                } while (c.moveToNext());
                try {
                ...
                try {
                    if (mCursor != null && shouldAddToPlaylist) {
                        ...
                        mPlaylist.add(new MusicPlaybackTrack(
                                mCursor.getLong(IDCOLIDX), -1, FirecubeUtils.IdType.NA, -1));
                        notifyChange(QUEUE_CHANGED);
                        mPlayPos = 0;
                        mHistory.clear();
                    }
    ...
    public void open(final long[] list, final int position, long sourceId, FirecubeUtils.IdType sourceType) {
        synchronized (this) {
            if (mShuffleMode == SHUFFLE_AUTO) {
...
//            }
    ...
    private static final class ServiceStub extends IFirecubeService.Stub {
