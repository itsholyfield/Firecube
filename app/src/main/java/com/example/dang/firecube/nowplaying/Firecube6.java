...
import com.example.dang.firecube.widgets.CircleImageView;

import net.steamcrafted.materialiconlib.MaterialDrawableBuilder;

public class Firecube6 extends BaseNowplayingFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(
                R.layout.fragment_firecube6, container, false);
    ...
    public void onMetaChanged() {
        ...
        if (getActivity() != null) {
            ...
            nextArt.setImageURI(FirecubeUtils.getAlbumArtUri(next.albumId));
        }
    }
}
