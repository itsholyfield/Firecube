...
public class DonateActivity extends BaseThemedActivity implements BillingProcessor.IBillingHandler {
    ...
    private static final String DONATION_1 = "example.dang.firecube.donate_1";
    private static final String DONATION_2 = "example.dang.firecube.donate_2";
    private static final String DONATION_3 = "example.dang.firecube.donate_3";
    private static final String DONATION_5 = "example.dang.firecube.donate_5";
    private static final String DONATION_10 = "example.dang.firecube.donate_10";
    private static final String DONATION_20 = "example.dang.firecube.donate_20";
