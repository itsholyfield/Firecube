...
import com.example.dang.firecube.IFirecubeService;
import com.example.dang.firecube.MusicPlayer;
import com.example.dang.firecube.MusicService;
...
import com.example.dang.firecube.subfragments.QuickControlsFragment;
...
import static com.example.dang.firecube.MusicPlayer.mService;
...
public class BaseActivity extends ATEActivity implements ServiceConnection, MusicStateListener {
    ...
    public void onServiceConnected(final ComponentName name, final IBinder service) {
        mService = IFirecubeService.Stub.asInterface(service);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (!FirecubeUtils.hasEffectsPanel(BaseActivity.this)) {
