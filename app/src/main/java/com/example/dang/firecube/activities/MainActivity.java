...
import com.example.dang.firecube.fragments.FoldersFragment;
import com.example.dang.firecube.fragments.MainFragment;
import com.example.dang.firecube.fragments.PlaylistFragment;
import com.example.dang.firecube.fragments.QueueFragment;
import com.example.dang.firecube.permissions.Nammu;
import com.example.dang.firecube.permissions.PermissionCallback;
import com.example.dang.firecube.slidinguppanel.SlidingUpPanelLayout;
    ...
    private void checkPermissionAndThenLoad() {
        ...
        if (Nammu.checkPermission(Manifest.permission.READ_EXTERNAL_STORAGE)) {
            ...
            if (Nammu.shouldShowRequestPermissionRationale(this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                Snackbar.make(panelLayout, "Firecube will need to read external storage to display songs on your device.",
